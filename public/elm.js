// elm-watch hot {"version":"1.1.2","targetName":"My target name","webSocketPort":64001}
"use strict";
(() => {
...
var $author$project$Main$assignFirstPlayerToken = function (model) {
	var _v0 = A2(
		$elm$random$Random$step,
		A2(
			$elm$random$Random$map,
		...
		model.seed);
	var firstPlayerId = _v0.a;
	var nextSeed = _v0.b;
	if (firstPlayerId.$ === 'Nothing') {
		return model;
	} else {
		var playerId = firstPlayerId.a;
...
var $author$project$Main$randomDoN = F3(
	function (count, fn, a) {
		return (count < 2) ? A2(fn, count, a) : A2(
			$elm$random$Random$andThen,
			function (b) {
				return $elm$random$Random$lazy(
					function (_v0) {
						return A3($author$project$Main$randomDoN, count - 1, fn, b);
					});
			},
			A2(fn, count, a));
	});
var $author$project$Main$tileToComparable = function (tile) {
	switch (tile.$) {
		case 'TileOne':
			return 1;
		case 'TileTwo':
...
var $author$project$Main$fillStores = function (model) {
	var _v0 = A2(
		$elm$random$Random$step,
		A3(
			$author$project$Main$randomDoN,
			9,
			F2(
				function (i, _v2) {
					var stores = _v2.a;
						...
						function (_v3) {
							...
							return _Utils_Tuple2(
								A3(
									...
									i,
									A2($elm$core$List$sortBy, $author$project$Main$tileToComparable, tiles),
									stores),
								newBag);
						},
						A2($elm_community$random_extra$Random$List$choices, 4, bag));
				}),
			_Utils_Tuple2($elm$core$Dict$empty, model.tileBag)),
		model.seed);
	var _v1 = _v0.a;
	var tileStores = _v1.a;
	var tileBag = _v1.b;
	var nextSeed = _v0.b;
	return _Utils_update(
		model,
		{seed: nextSeed, tileBag: tileBag, tileStores: tileStores});
};
...
var $author$project$Main$initPlayer = {
	board: $elm$core$Array$fromList(
		A2($elm$core$List$repeat, 25, $author$project$Main$Empty)),
	isFirstPlayer: false,
	negatives: _List_Nil,
	score: 0,
	staging: {
		rowFive: _List_fromArray(
			[$author$project$Main$Empty, $author$project$Main$Empty, $author$project$Main$Empty, $author$project$Main$Empty, $author$project$Main$Empty]),
		rowFour: _List_fromArray(
			[$author$project$Main$Empty, $author$project$Main$Empty, $author$project$Main$Empty, $author$project$Main$Empty]),
		rowOne: _List_fromArray(
			[$author$project$Main$Empty]),
		rowThree: _List_fromArray(
			[$author$project$Main$Empty, $author$project$Main$Empty, $author$project$Main$Empty]),
		rowTwo: _List_fromArray(
			[$author$project$Main$Empty, $author$project$Main$Empty])
	},
	toPlace: _List_Nil
};
...
var $author$project$Main$TileFive = {$: 'TileFive'};
var $author$project$Main$TileFour = {$: 'TileFour'};
var $author$project$Main$TileOne = {$: 'TileOne'};
var $author$project$Main$TileThree = {$: 'TileThree'};
var $author$project$Main$TileTwo = {$: 'TileTwo'};
var $author$project$Main$initialTiles = _Utils_ap(
	A2($elm$core$List$repeat, 20, $author$project$Main$TileOne),
	_Utils_ap(
		A2($elm$core$List$repeat, 20, $author$project$Main$TileTwo),
		_Utils_ap(
			A2($elm$core$List$repeat, 20, $author$project$Main$TileThree),
			_Utils_ap(
				A2($elm$core$List$repeat, 20, $author$project$Main$TileFour),
				A2($elm$core$List$repeat, 20, $author$project$Main$TileFive)))));
var $elm$core$Tuple$pair = F2(
	function (a, b) {
		return _Utils_Tuple2(a, b);
	});
var $author$project$Main$newGameModel = function (model) {
	var _v0 = A2(
		$elm$random$Random$step,
		$elm_community$random_extra$Random$List$shuffle($author$project$Main$initialTiles),
		model.seed);
	var shuffledTiles = _v0.a;
	var seed = _v0.b;
	return _Utils_update(
		model,
		{
			discardedTiles: _List_Nil,
			players: $elm$core$Dict$fromList(
				_List_fromArray(
					[
						_Utils_Tuple2('player1', $author$project$Main$initPlayer),
						_Utils_Tuple2('player2', $author$project$Main$initPlayer)
					])),
			seed: seed,
			tileBag: shuffledTiles,
			tilePool: {firstPlayerToken: false, tiles: _List_Nil},
			tileStores: $elm$core$Dict$fromList(
				A2(
					$elm$core$List$indexedMap,
					$elm$core$Tuple$pair,
					A2($elm$core$List$repeat, 9, _List_Nil)))
		});
};
...
var $author$project$Main$init = function (initialSeed) {
	return _Utils_Tuple2(
		$author$project$Main$assignFirstPlayerToken(
			$author$project$Main$fillStores(
				$author$project$Main$newGameModel(
					{
						discardedTiles: _List_Nil,
						playerTurn: 'player1',
						players: $elm$core$Dict$fromList(
						...
						seed: $elm$random$Random$initialSeed(initialSeed),
						tileBag: $author$project$Main$initialTiles,
						tilePool: {firstPlayerToken: false, tiles: _List_Nil},
						tileStores: $elm$core$Dict$fromList(
							A2(
								$elm$core$List$indexedMap,
		...
		switch (msg.$) {
			case 'NewGame':
				return _Utils_Tuple2(
					$author$project$Main$assignFirstPlayerToken(
						$author$project$Main$fillStores(
							$author$project$Main$newGameModel(model))),
					$elm$core$Platform$Cmd$none);
			case 'StoreTileClicked':
				var playerId = msg.a;
				var storeIndex = msg.b;
				var tile = msg.c;
				var tilePool = model.tilePool;
				var _v1 = A2(
					$elm$core$List$partition,
					function (t) {
						return _Utils_eq(t, tile);
					},
					A2(
						$elm$core$Maybe$withDefault,
						_List_Nil,
						A2($elm$core$Dict$get, storeIndex, model.tileStores)));
				var playerTiles = _v1.a;
				var pileTiles = _v1.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
								...
								$elm$core$Maybe$map(
									function (player) {
										return _Utils_update(
											player,
											{
												toPlace: A2($elm$core$List$sortBy, $author$project$Main$tileToComparable, playerTiles)
											});
									}),
								model.players),
							tilePool: _Utils_update(
								tilePool,
								{
									tiles: A2(
										$elm$core$List$sortBy,
										$author$project$Main$tileToComparable,
										_Utils_ap(model.tilePool.tiles, pileTiles))
								}),
							tileStores: A3($elm$core$Dict$insert, storeIndex, _List_Nil, model.tileStores)
						}),
					$elm$core$Platform$Cmd$none);
			case 'PoolTileClicked':
				var playerId = msg.a;
				var tile = msg.b;
				return _Debug_todo(
					'Main',
...
var $author$project$Main$PoolTileClicked = F2(
	function (a, b) {
		return {$: 'PoolTileClicked', a: a, b: b};
	});
var $elm$html$Html$div = _VirtualDom_node('div');
var $author$project$Main$PlayerPoolTileClicked = F2(
	function (a, b) {
		return {$: 'PlayerPoolTileClicked', a: a, b: b};
	});
...
var $author$project$Main$tileToString = function (tile) {
	switch (tile.$) {
		case 'TileOne':
			return '1';
		case 'TileTwo':
	...
	function (clickHandler, tile) {
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$text(
					$author$project$Main$tileToString(tile))
				]));
	});
var $author$project$Main$viewTileOrEmpty = function (tileOrEmpty) {
	if (tileOrEmpty.$ === 'Empty') {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
...
var $author$project$Main$viewPlayer = function (_v0) {
	var id = _v0.a;
	var player = _v0.b;
	var stagingWrapper = $elm$core$List$indexedMap(
		F2(
			function (i, tileOrEmpty) {
				return A2(
					$elm$html$Html$div,
					_List_fromArray(
						[
							...
							'grid-column',
							$elm$core$String$fromInt(5 - i)),
							A2($elm$html$Html$Attributes$style, 'grid-row', '1')
						]),
					_List_fromArray(
						[
							$author$project$Main$viewTileOrEmpty(tileOrEmpty)
						]));
			}));
	var stagingGrid = $elm$html$Html$div(
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Fst')
							])) : $elm$html$Html$text(''),
						stagingGrid(
						stagingWrapper(player.staging.rowOne)),
						stagingGrid(
						stagingWrapper(player.staging.rowTwo)),
						stagingGrid(
						stagingWrapper(player.staging.rowThree)),
						stagingGrid(
						stagingWrapper(player.staging.rowFour)),
						stagingGrid(
						stagingWrapper(player.staging.rowFive))
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				A2(
					$elm$core$List$map,
					$author$project$Main$viewTileOrEmpty,
					$elm$core$Array$toList(player.board))),
				A2(
				$elm$html$Html$div,
				_List_Nil,
				A2(
					...
					$author$project$Main$viewTile(
						$author$project$Main$PlayerPoolTileClicked(id)),
					player.toPlace))
			]));
};
var $author$project$Main$StoreTileClicked = F3(
	function (a, b, c) {
		return {$: 'StoreTileClicked', a: a, b: b, c: c};
	});
var $author$project$Main$viewTileStore = F2(
	function (playerId, _v0) {
		var index = _v0.a;
		var tiles = _v0.b;
		return A2(
			$elm$html$Html$div,
			...
			A2(
				$elm$core$List$map,
				$author$project$Main$viewTile(
					A2($author$project$Main$StoreTileClicked, playerId, index)),
				tiles));
	});
	...
	return {
		body: _List_fromArray(
			[
				...
				A2(
					$elm$core$List$map,
					$author$project$Main$viewTileStore(model.playerTurn),
					$elm$core$Dict$toList(model.tileStores))),
				A2(
				$elm$html$Html$div,
				_List_Nil,
				A2(
					$elm$core$List$map,
					$author$project$Main$viewTile(
						$author$project$Main$PoolTileClicked(model.playerTurn)),
